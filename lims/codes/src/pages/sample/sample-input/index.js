...
// 列配置
const colString =
	"序号	状态	样品条码	样品编码	样品名称	样品类型	重量（体积）	单位	样品数量	检测项	送样单位	送样人	取样地点	取样时间	退回原因	备注";
...
// 列配置
const col2String =
	"序号	状态	收样日期	样品名称	样品批号	检测编号	样品原号	样品条码	样品类别	贵重金属	重量（体积）	样品数量	检测项	备注";
